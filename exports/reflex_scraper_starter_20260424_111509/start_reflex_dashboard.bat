...
:: ── Telegram Monitor (visible window, polls every 60s) ─────────────────────
set T84_ROOT=G:\My Drive\0dev\t84
set T84_PYTHON=C:\Python313\python.exe
if not exist "%T84_PYTHON%" set T84_PYTHON=python
echo [INFO] Starting Telegram monitor (visible window)...
start "T84 Telegram Monitor" cmd /k ""%T84_PYTHON%" "%T84_ROOT%\xscripts\telegram_monitor.py""
echo [OK]  Telegram monitor window opened.
echo.
