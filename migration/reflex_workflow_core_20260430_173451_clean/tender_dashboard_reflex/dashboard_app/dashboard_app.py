...
from dashboard_app.scraping_control import (
    scraping_control_page,
    scraping_settings_page,
    ScrapingControlState,
    bootstrap_scheduler_on_startup,
)
...
app = rx.App()
app.register_lifespan_task(bootstrap_scheduler_on_startup)
