"""Script to build the complete enhanced dashboard_app.py"""
...
if __name__ == "__main__":
    import pathlib
    target = pathlib.Path(__file__).parent / "dashboard_app" / "dashboard_app.py"
    target.write_text(DASHBOARD_CONTENT, encoding="utf-8")
