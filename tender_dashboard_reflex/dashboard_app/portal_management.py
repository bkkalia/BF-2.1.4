        ...
        rx.dialog.content(
            ...
            rx.vstack(
                ...
                rx.hstack(
                    ...
                    rx.button(
                        rx.icon("download"),
                        "Export Selected (Single File)",
                        on_click=PortalManagementState.export_selected_portals_single_excel,
                        color_scheme="blue",
                        size="2",
                        loading=PortalManagementState.exporting,
                    ),
            ...
            rx.vstack(
                ...
                rx.hstack(
                    ...
                    rx.button(
                        ...
                        on_click=PortalManagementState.export_all_portals_single_excel,
                        color_scheme="violet",
                        variant="ghost",
                        size="2",
                        loading=PortalManagementState.exporting,
